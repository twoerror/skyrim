...
public class TESClassTransformer implements IClassTransformer {
	...
	public byte[] patchArmorProperties(String name, byte[] bytes) {
		...
		boolean isCauldron = TESModChecker.isCauldronServer();
		...
		for (MethodNode method : classNode.methods) {
			...
			if (method.name.equals(targetMethodName) && method.desc.equals(targetMethodSign)) {
				...
				if (!((nodePrev = nodeFound.getPrevious()) instanceof VarInsnNode) || nodePrev.getOpcode() != 25 || ((VarInsnNode) nodePrev).var != 9) {
					System.out.println("WARNING! Expected ALOAD 9! Instead tes " + nodePrev);
				...
				newIns.add(new MethodInsnNode(INVOKESTATIC, "tes/coremod/TESReplacedMethods$Enchants", "getDamageReduceAmount", "(Lnet/minecraft/item/ItemStack;)I", false));
	...
	public byte[] patchBlockAnvil(String name, byte[] bytes) {
		...
		newMethod.instructions.add(new MethodInsnNode(INVOKESTATIC, "tes/coremod/TESReplacedMethods$Anvil", "getCollisionBoundingBoxFromPool", "(Lnet/minecraft/block/Block;Lnet/minecraft/world/World;III)Lnet/minecraft/util/AxisAlignedBB;", false));
	...
	public byte[] patchBlockCauldron(String name, byte[] bytes) {
		...
		for (MethodNode method : classNode.methods) {
			if ((method.name.equals(targetMethodName) || method.name.equals(targetMethodNameObf)) && method.desc.equals(targetMethodSign)) {
				...
				InsnList newIns = new InsnList();
				newIns.add(new MethodInsnNode(INVOKESTATIC, "tes/coremod/TESReplacedMethods$Cauldron", "getRenderType", "()I", false));
	...
	public byte[] patchBlockDirt(String name, byte[] bytes) {
		...
		for (MethodNode method : classNode.methods) {
			...
			if ("<clinit>".equals(method.name)) {
				...
				method.instructions.set(nodeNameIndex1, new LdcInsnNode(TESReplacedMethods.Dirt.nameIndex1));
				System.out.println("Hummel009: Patched method " + method.name);
			}
			if ((method.name.equals(targetMethodName) || method.name.equals(targetMethodNameObf)) && method.desc.equals(targetMethodSign)) {
				method.instructions.clear();
				...
				newIns.add(new MethodInsnNode(INVOKESTATIC, "tes/coremod/TESReplacedMethods$Dirt", "damageDropped", "(I)I", false));
				newIns.add(new InsnNode(IRETURN));
				method.instructions.insert(newIns);
				System.out.println("Hummel009: Patched method " + method.name);
			}
			if ((method.name.equals(targetMethodName2) || method.name.equals(targetMethodNameObf2)) && (method.desc.equals(targetMethodSign2) || method.desc.equals(targetMethodSignObf2))) {
				...
				newIns.add(new VarInsnNode(ILOAD, 1));
				newIns.add(new MethodInsnNode(INVOKESTATIC, "tes/coremod/TESReplacedMethods$Dirt", "createStackedBlock", "(Lnet/minecraft/block/Block;I)Lnet/minecraft/item/ItemStack;", false));
			...
			if ((method.name.equals(targetMethodName3) || method.name.equals(targetMethodNameObf3)) && (method.desc.equals(targetMethodSign3) || method.desc.equals(targetMethodSignObf3))) {
				...
				newIns.add(new MethodInsnNode(INVOKESTATIC, "tes/coremod/TESReplacedMethods$Dirt", "getSubBlocks", "(Lnet/minecraft/block/Block;Lnet/minecraft/item/Item;Lnet/minecraft/creativetab/CreativeTabs;Ljava/util/List;)V", false));
			...
			if ((method.name.equals(targetMethodName4) || method.name.equals(targetMethodNameObf4)) && (method.desc.equals(targetMethodSign4) || method.desc.equals(targetMethodSignObf4))) {
				...
				newIns.add(new MethodInsnNode(INVOKESTATIC, "tes/coremod/TESReplacedMethods$Dirt", "getDamageValue", "(Lnet/minecraft/world/World;III)I", false));
				newIns.add(new InsnNode(IRETURN));
				method.instructions.insert(newIns);
				System.out.println("Hummel009: Patched method " + method.name);
			}
	...
	public byte[] patchBlockFence(String name, byte[] bytes) {
		...
		for (MethodNode method : classNode.methods) {
			...
			if ((method.name.equals(targetMethodName) || method.name.equals(targetMethodNameObf)) && (method.desc.equals(targetMethodSign) || method.desc.equals(targetMethodSignObf))) {
				...
				newIns.add(new VarInsnNode(ILOAD, 3));
				newIns.add(new VarInsnNode(ILOAD, 4));
				newIns.add(new MethodInsnNode(INVOKESTATIC, "tes/coremod/TESReplacedMethods$Fence", "canConnectFenceTo", "(Lnet/minecraft/world/IBlockAccess;III)Z", false));
				newIns.add(new InsnNode(IRETURN));
				method.instructions.insert(newIns);
				System.out.println("Hummel009: Patched method " + method.name);
			}
			if (method.name.equals(targetMethodName2) && (method.desc.equals(targetMethodSign2) || method.desc.equals(targetMethodSignObf2))) {
				...
				newIns = new InsnList();
				newIns.add(new VarInsnNode(ALOAD, 0));
				newIns.add(new MethodInsnNode(INVOKESTATIC, "tes/coremod/TESReplacedMethods$Fence", "canPlacePressurePlate", "(Lnet/minecraft/block/Block;)Z", false));
				newIns.add(new InsnNode(IRETURN));
				method.instructions.insert(newIns);
				System.out.println("Hummel009: Patched method " + method.name);
			}
	...
	public byte[] patchBlockGrass(String name, byte[] bytes) {
		...
		for (MethodNode method : classNode.methods) {
			if ((method.name.equals(targetMethodName) || method.name.equals(targetMethodNameObf)) && (method.desc.equals(targetMethodSign) || method.desc.equals(targetMethodSignObf))) {
				...
				newIns.add(new MethodInsnNode(INVOKESTATIC, "tes/coremod/TESReplacedMethods$Grass", "updateTick", "(Lnet/minecraft/world/World;IIILjava/util/Random;)V", false));
				newIns.add(new InsnNode(RETURN));
				method.instructions.insert(newIns);
				System.out.println("Hummel009: Patched method " + method.name);
			}
	...
	public byte[] patchBlockPistonBase(String name, byte[] bytes) {
		...
		for (MethodNode method : classNode.methods) {
			...
			do {
				...
				nodeFound.owner = "tes/coremod/TESReplacedMethods$Piston";
	...
	public byte[] patchBlockStaticLiquid(String name, byte[] bytes) {
		...
		for (MethodNode method : classNode.methods) {
			if ((method.name.equals(targetMethodName) || method.name.equals(targetMethodNameObf)) && (method.desc.equals(targetMethodSign) || method.desc.equals(targetMethodSignObf))) {
				...
				newIns.add(new VarInsnNode(ILOAD, 4));
				newIns.add(new VarInsnNode(ALOAD, 5));
				newIns.add(new MethodInsnNode(INVOKESTATIC, "tes/coremod/TESReplacedMethods$StaticLiquid", "updateTick", "(Lnet/minecraft/block/Block;Lnet/minecraft/world/World;IIILjava/util/Random;)V", false));
				newIns.add(new InsnNode(RETURN));
				method.instructions.insert(newIns);
				System.out.println("Hummel009: Patched method " + method.name);
			}
	...
	public byte[] patchBlockStone(String name, byte[] bytes) {
		...
		newMethod.instructions.add(new MethodInsnNode(INVOKESTATIC, "tes/coremod/TESReplacedMethods$Stone", "getIconWorld", "(Lnet/minecraft/block/Block;Lnet/minecraft/world/IBlockAccess;IIII)Lnet/minecraft/util/IIcon;", false));
		newMethod.instructions.add(new InsnNode(ARETURN));
		classNode.methods.add(newMethod);
		System.out.println("Hummel009: Added method " + newMethod.name);
		...
		newMethod.instructions.add(new VarInsnNode(ILOAD, 2));
		newMethod.instructions.add(new MethodInsnNode(INVOKESTATIC, "tes/coremod/TESReplacedMethods$Stone", "getIconSideMeta", "(Lnet/minecraft/block/Block;Lnet/minecraft/util/IIcon;II)Lnet/minecraft/util/IIcon;", false));
		newMethod.instructions.add(new InsnNode(ARETURN));
		classNode.methods.add(newMethod);
		System.out.println("Hummel009: Added method " + newMethod.name);
		ClassWriter writer = new ClassWriter(1);
	...
	public byte[] patchBlockTrapdoor(String name, byte[] bytes) {
		...
		for (MethodNode method : classNode.methods) {
			...
			if ((method.name.equals(targetMethodName) || method.name.equals(targetMethodNameObf)) && (method.desc.equals(targetMethodSign) || method.desc.equals(targetMethodSignObf))) {
				...
				newIns.add(new MethodInsnNode(INVOKESTATIC, "tes/coremod/TESReplacedMethods$Trapdoor", "canPlaceBlockOnSide", "(Lnet/minecraft/world/World;IIII)Z", false));
				newIns.add(new InsnNode(IRETURN));
				method.instructions.insert(newIns);
				System.out.println("Hummel009: Patched method " + method.name);
			}
			if (method.name.equals(targetMethodName2) && (method.desc.equals(targetMethodSign2) || method.desc.equals(targetMethodSignObf2))) {
				...
				newIns = new InsnList();
				newIns.add(new VarInsnNode(ALOAD, 0));
				newIns.add(new MethodInsnNode(INVOKESTATIC, "tes/coremod/TESReplacedMethods$Trapdoor", "isValidSupportBlock", "(Lnet/minecraft/block/Block;)Z", false));
				newIns.add(new InsnNode(IRETURN));
				method.instructions.insert(newIns);
				System.out.println("Hummel009: Patched method " + method.name);
			}
			if ((method.name.equals(targetMethodName3) || method.name.equals(targetMethodNameObf3)) && method.desc.equals(targetMethodSign3)) {
				...
				newIns = new InsnList();
				newIns.add(new VarInsnNode(ALOAD, 0));
				newIns.add(new MethodInsnNode(INVOKESTATIC, "tes/coremod/TESReplacedMethods$Trapdoor", "getRenderType", "(Lnet/minecraft/block/Block;)I", false));
				newIns.add(new InsnNode(IRETURN));
				method.instructions.insert(newIns);
				System.out.println("Hummel009: Patched method " + method.name);
			}
	...
	public byte[] patchBlockWall(String name, byte[] bytes) {
		...
		for (MethodNode method : classNode.methods) {
			if ((method.name.equals(targetMethodName) || method.name.equals(targetMethodNameObf)) && (method.desc.equals(targetMethodSign) || method.desc.equals(targetMethodSignObf))) {
				...
				newIns.add(new VarInsnNode(ILOAD, 3));
				newIns.add(new VarInsnNode(ILOAD, 4));
				newIns.add(new MethodInsnNode(INVOKESTATIC, "tes/coremod/TESReplacedMethods$Wall", "canConnectWallTo", "(Lnet/minecraft/world/IBlockAccess;III)Z", false));
				newIns.add(new InsnNode(IRETURN));
				method.instructions.insert(newIns);
				System.out.println("Hummel009: Patched method " + method.name);
			}
	...
	public byte[] patchDoorInteract(String name, byte[] bytes) {
		...
		for (MethodNode method : classNode.methods) {
			if (method.name.equals(targetMethodName) && (method.desc.equals(targetMethodSign) || method.desc.equals(targetMethodSignObf))) {
				...
				MethodInsnNode nodeCheckDoor = new MethodInsnNode(INVOKESTATIC, "tes/coremod/TESReplacedMethods$PathFinder", "isWoodenDoor", "(Lnet/minecraft/block/Block;)Z", false);
	...
	public byte[] patchEnchantmentHelper(String name, byte[] bytes) {
		...
		for (MethodNode method : classNode.methods) {
			...
			if ((method.name.equals(targetMethodName) || method.name.equals(targetMethodNameObf)) && (method.desc.equals(targetMethodSign) || method.desc.equals(targetMethodSignObf))) {
				...
				extraIns.add(new MethodInsnNode(INVOKESTATIC, "tes/coremod/TESReplacedMethods$Enchants", "getEnchantmentModifierLiving", "(FLnet/minecraft/entity/EntityLivingBase;Lnet/minecraft/entity/EntityLivingBase;)F", false));
			...
			if (method.name.equals(targetMethodName2) && (method.desc.equals(targetMethodSign2) || method.desc.equals(targetMethodSignObf2))) {
				...
				extraIns.add(new VarInsnNode(ALOAD, 0));
				extraIns.add(new VarInsnNode(ALOAD, 1));
				extraIns.add(new MethodInsnNode(INVOKESTATIC, "tes/coremod/TESReplacedMethods$Enchants", "func_152377_a", "(FLnet/minecraft/item/ItemStack;Lnet/minecraft/entity/EnumCreatureAttribute;)F", false));
				method.instructions.insertBefore(nodeReturn, extraIns);
				System.out.println("Hummel009: Patched method " + method.name);
			}
			if ((method.name.equals(targetMethodName3) || method.name.equals(targetMethodNameObf3)) && (method.desc.equals(targetMethodSign3) || method.desc.equals(targetMethodSignObf3))) {
				...
				extraIns = new InsnList();
				extraIns.add(new VarInsnNode(ALOAD, 0));
				extraIns.add(new MethodInsnNode(INVOKESTATIC, "tes/coremod/TESReplacedMethods$Enchants", "getSilkTouchModifier", "(ZLnet/minecraft/entity/EntityLivingBase;)Z", false));
				method.instructions.insertBefore(nodeReturn, extraIns);
				System.out.println("Hummel009: Patched method " + method.name);
			}
			if ((method.name.equals(targetMethodName4) || method.name.equals(targetMethodNameObf4)) && (method.desc.equals(targetMethodSign4) || method.desc.equals(targetMethodSignObf4))) {
				...
				extraIns.add(new VarInsnNode(ALOAD, 0));
				extraIns.add(new VarInsnNode(ALOAD, 1));
				extraIns.add(new MethodInsnNode(INVOKESTATIC, "tes/coremod/TESReplacedMethods$Enchants", "getKnockbackModifier", "(ILnet/minecraft/entity/EntityLivingBase;Lnet/minecraft/entity/EntityLivingBase;)I", false));
				method.instructions.insertBefore(nodeReturn, extraIns);
				System.out.println("Hummel009: Patched method " + method.name);
			}
			if ((method.name.equals(targetMethodName5) || method.name.equals(targetMethodNameObf5)) && (method.desc.equals(targetMethodSign5) || method.desc.equals(targetMethodSignObf5))) {
				...
				extraIns = new InsnList();
				extraIns.add(new VarInsnNode(ALOAD, 0));
				extraIns.add(new MethodInsnNode(INVOKESTATIC, "tes/coremod/TESReplacedMethods$Enchants", "getFortuneModifier", "(ILnet/minecraft/entity/EntityLivingBase;)I", false));
				method.instructions.insertBefore(nodeReturn, extraIns);
				System.out.println("Hummel009: Patched method " + method.name);
			}
			if ((method.name.equals(targetMethodName6) || method.name.equals(targetMethodNameObf6)) && (method.desc.equals(targetMethodSign6) || method.desc.equals(targetMethodSignObf6))) {
				...
				extraIns = new InsnList();
				extraIns.add(new VarInsnNode(ALOAD, 0));
				extraIns.add(new MethodInsnNode(INVOKESTATIC, "tes/coremod/TESReplacedMethods$Enchants", "getLootingotifier", "(ILnet/minecraft/entity/EntityLivingBase;)I", false));
				method.instructions.insertBefore(nodeReturn, extraIns);
				System.out.println("Hummel009: Patched method " + method.name);
			}
			if ((method.name.equals(targetMethodName7) || method.name.equals(targetMethodNameObf7)) && (method.desc.equals(targetMethodSign7) || method.desc.equals(targetMethodSignObf7))) {
				...
				extraIns.add(new VarInsnNode(ALOAD, 0));
				extraIns.add(new VarInsnNode(ALOAD, 1));
				extraIns.add(new MethodInsnNode(INVOKESTATIC, "tes/coremod/TESReplacedMethods$Enchants", "getSpecialArmorProtection", "(I[Lnet/minecraft/item/ItemStack;Lnet/minecraft/util/DamageSource;)I", false));
				method.instructions.insertBefore(nodeReturn, extraIns);
				System.out.println("Hummel009: Patched method " + method.name);
			}
			if ((method.name.equals(targetMethodName8) || method.name.equals(targetMethodNameObf8)) && (method.desc.equals(targetMethodSign8) || method.desc.equals(targetMethodSignObf8))) {
				...
				extraIns = new InsnList();
				extraIns.add(new VarInsnNode(ALOAD, 0));
				extraIns.add(new MethodInsnNode(INVOKESTATIC, "tes/coremod/TESReplacedMethods$Enchants", "getFireAspectModifier", "(ILnet/minecraft/entity/EntityLivingBase;)I", false));
				method.instructions.insertBefore(nodeReturn, extraIns);
				System.out.println("Hummel009: Patched method " + method.name);
			}
		}
	...
	public byte[] patchEnchantmentProtection(String name, byte[] bytes) {
		...
		for (MethodNode method : classNode.methods) {
			if ((method.name.equals(targetMethodName) || method.name.equals(targetMethodNameObf)) && (method.desc.equals(targetMethodSign) || method.desc.equals(targetMethodSignObf))) {
				...
				InsnList newIns = new InsnList();
				newIns.add(new VarInsnNode(ALOAD, 0));
				newIns.add(new MethodInsnNode(INVOKESTATIC, "tes/coremod/TESReplacedMethods$Enchants", "getMaxFireProtectionLevel", "(ILnet/minecraft/entity/Entity;)I", false));
	...
	public byte[] patchEntityClientPlayerMP(String name, byte[] bytes) {
		...
		for (MethodNode method : classNode.methods) {
			if (method.name.equals(targetMethodName) && method.desc.equals(targetMethodSign)) {
				...
				InsnList newIns = new InsnList();
				newIns.add(new VarInsnNode(ALOAD, 0));
				newIns.add(new MethodInsnNode(INVOKESTATIC, "tes/coremod/TESReplacedMethods$ClientPlayer", "horseJump", "(Lnet/minecraft/client/entity/EntityClientPlayerMP;)V", false));
				newIns.add(new InsnNode(RETURN));
				method.instructions.insert(newIns);
				System.out.println("Hummel009: Patched method " + method.name);
			}
		...
		for (MethodNode method : classNode.methods) {
			if ((method.name.equals(targetMethodName) || method.name.equals(targetMethodNameObf)) && method.desc.equals(targetMethodSign)) {
				...
				if (nodeIfTest.getOpcode() == 154) {
					...
					System.out.println("WARNING! Expected IFNE! Instead tes " + nodeIfTest.getOpcode());
					System.out.println("WARNING! Things may break!");
				}
				InsnList newIns = new InsnList();
				newIns.add(new MethodInsnNode(INVOKESTATIC, "tes/coremod/TESReplacedMethods$MountFunctions", "canRiderControl_elseNoMotion", "(Lnet/minecraft/entity/EntityLiving;)Z", false));
		...
		for (MethodNode method : classNode.methods) {
			if ((method.name.equals(targetMethodName) || method.name.equals(targetMethodNameObf)) && method.desc.equals(targetMethodSign)) {
				...
				if (!(newPrev instanceof VarInsnNode) || newPrev.getOpcode() != 25 || ((VarInsnNode) newPrev).var != 5) {
					System.out.println("WARNING! Expected ALOAD 5! Instead tes " + newPrev);
					System.out.println("WARNING! Things may break!");
				}
				InsnList newIns22 = new InsnList();
				newIns22.add(new MethodInsnNode(INVOKESTATIC, "tes/coremod/TESReplacedMethods$Enchants", "getDamageReduceAmount", "(Lnet/minecraft/item/ItemStack;)I", false));
			...
			if ((method.name.equals(targetMethodName2) || method.name.equals(targetMethodNameObf2)) && (method.desc.equals(targetMethodSign2) || method.desc.equals(targetMethodSignObf2))) {
				...
				newIns221.add(new MethodInsnNode(INVOKESTATIC, "tes/coremod/TESReplacedMethods$Enchants", "isPlayerMeleeKill", "(Lnet/minecraft/entity/Entity;Lnet/minecraft/util/DamageSource;)Z", false));
	...
	public byte[] patchEntityPlayer(String name, byte[] bytes) {
		...
		for (MethodNode method : classNode.methods) {
			if ((method.name.equals(targetMethodName) || method.name.equals(targetMethodNameObf)) && method.desc.equals(targetMethodSign)) {
				...
				newIns.add(new VarInsnNode(ALOAD, 0));
				newIns.add(new VarInsnNode(ILOAD, 1));
				newIns.add(new MethodInsnNode(INVOKESTATIC, "tes/coremod/TESReplacedMethods$Player", "canEat", "(Lnet/minecraft/entity/player/EntityPlayer;Z)Z", false));
				newIns.add(new InsnNode(IRETURN));
				method.instructions.insert(newIns);
				System.out.println("Hummel009: Patched method " + method.name);
			}
	...
	public byte[] patchFMLNetworkHandler(String name, byte[] bytes) {
		...
		for (MethodNode method : classNode.methods) {
			if (method.name.equals(targetMethodName) && (method.desc.equals(targetMethodSign) || method.desc.equals(targetMethodSignObf))) {
				...
				InsnList newIns = new InsnList();
				newIns.add(new VarInsnNode(ALOAD, 0));
				newIns.add(new MethodInsnNode(INVOKESTATIC, "tes/coremod/TESReplacedMethods$EntityPackets", "getMobSpawnPacket", "(Lnet/minecraft/entity/Entity;)Lnet/minecraft/network/Packet;", false));
				newIns.add(new InsnNode(ARETURN));
				method.instructions.insert(newIns);
				System.out.println("Hummel009: Patched method " + method.name);
			}
	...
	public byte[] patchFoodStats(String name, byte[] bytes) {
		...
		for (MethodNode method : classNode.methods) {
			if ((method.name.equals(targetMethodName) || method.name.equals(targetMethodNameObf)) && method.desc.equals(targetMethodSign)) {
				...
				newIns.add(new MethodInsnNode(INVOKESTATIC, "tes/coremod/TESReplacedMethods$Food", "getExhaustionFactor", "()F", false));
	...
	public byte[] patchGui(String name, byte[] bytes) {
		...
		newMethod.instructions.add(new VarInsnNode(ILOAD, 4));
		newMethod.instructions.add(new VarInsnNode(ILOAD, 5));
		newMethod.instructions.add(new MethodInsnNode(INVOKESTATIC, "tes/coremod/TESReplacedMethods$Gui", "drawCenteredStringWithoutShadow", "(Lnet/minecraft/client/gui/FontRenderer;Ljava/lang/String;III)V", false));
				...
				if (isCauldron) {
					for (AbstractInsnNode n : method.instructions.toArray()) {
						if (n.getOpcode() == 100) {
							...
							insns.add(new MethodInsnNode(INVOKESTATIC, "tes/coremod/TESReplacedMethods$Enchants", "c_attemptDamageItem", "(ILnet/minecraft/item/ItemStack;ILjava/util/Random;Lnet/minecraft/entity/EntityLivingBase;)I", false));
					...
					newIns.add(new VarInsnNode(ILOAD, 1));
					newIns.add(new VarInsnNode(ALOAD, 2));
					newIns.add(new MethodInsnNode(INVOKESTATIC, "tes/coremod/TESReplacedMethods$Enchants", "attemptDamageItem", "(Lnet/minecraft/item/ItemStack;ILjava/util/Random;)Z", false));
					newIns.add(new InsnNode(IRETURN));
					method.instructions.insert(newIns);
					System.out.println("Hummel009: Patched method " + method.name);
				}
	...
	public byte[] patchNetHandlerClient(String name, byte[] bytes) {
		...
		for (MethodNode method : classNode.methods) {
			...
			if ((method.name.equals(targetMethodName) || method.name.equals(targetMethodNameObf)) && (method.desc.equals(targetMethodSign) || method.desc.equals(targetMethodSignObf))) {
				...
				newIns.add(new VarInsnNode(ALOAD, 0));
				newIns.add(new VarInsnNode(ALOAD, 1));
				newIns.add(new MethodInsnNode(INVOKESTATIC, "tes/coremod/TESReplacedMethods$NetHandlerClient", "handleEntityTeleport", "(Lnet/minecraft/client/network/NetHandlerPlayClient;Lnet/minecraft/network/play/server/S18PacketEntityTeleport;)V", false));
				newIns.add(new InsnNode(RETURN));
				method.instructions.insert(newIns);
				System.out.println("Hummel009: Patched method " + method.name);
			}
			if ((method.name.equals(targetMethodName2) || method.name.equals(targetMethodNameObf2)) && (method.desc.equals(targetMethodSign2) || method.desc.equals(targetMethodSignObf2))) {
				...
				newIns.add(new VarInsnNode(ALOAD, 0));
				newIns.add(new VarInsnNode(ALOAD, 1));
				newIns.add(new MethodInsnNode(INVOKESTATIC, "tes/coremod/TESReplacedMethods$NetHandlerClient", "handleEntityMovement", "(Lnet/minecraft/client/network/NetHandlerPlayClient;Lnet/minecraft/network/play/server/S14PacketEntity;)V", false));
				newIns.add(new InsnNode(RETURN));
				method.instructions.insert(newIns);
				System.out.println("Hummel009: Patched method " + method.name);
			}
	...
	public byte[] patchPathFinder(String name, byte[] bytes) {
		...
		for (MethodNode method : classNode.methods) {
			if (method.name.equals(targetMethodName) && (method.desc.equals(targetMethodSign) || method.desc.equals(targetMethodSignObf))) {
				...
				MethodInsnNode nodeCheckDoor1 = new MethodInsnNode(INVOKESTATIC, "tes/coremod/TESReplacedMethods$PathFinder", "isWoodenDoor", "(Lnet/minecraft/block/Block;)Z", false);
				...
				MethodInsnNode nodeCheckDoor2 = new MethodInsnNode(INVOKESTATIC, "tes/coremod/TESReplacedMethods$PathFinder", "isWoodenDoor", "(Lnet/minecraft/block/Block;)Z", false);
				...
				MethodInsnNode nodeCheckGate = new MethodInsnNode(INVOKESTATIC, "tes/coremod/TESReplacedMethods$PathFinder", "isFenceGate", "(Lnet/minecraft/block/Block;)Z", false);
	...
	public byte[] patchPotionDamage(String name, byte[] bytes) {
		...
		for (MethodNode method : classNode.methods) {
			if (method.name.equals(targetMethodName) && (method.desc.equals(targetMethodSign) || method.desc.equals(targetMethodSignObf))) {
				...
				newIns.add(new VarInsnNode(ILOAD, 1));
				newIns.add(new VarInsnNode(ALOAD, 2));
				newIns.add(new MethodInsnNode(INVOKESTATIC, "tes/coremod/TESReplacedMethods$Potions", "getStrengthModifier", "(Lnet/minecraft/potion/Potion;ILnet/minecraft/entity/ai/attributes/AttributeModifier;)D", false));
	...
	public byte[] patchSpawnerAnimals(String name, byte[] bytes) {
		...
		for (MethodNode method : classNode.methods) {
			if ((method.name.equals(targetMethodName) || method.name.equals(targetMethodNameObf)) && (method.desc.equals(targetMethodSign) || method.desc.equals(targetMethodSignObf))) {
				...
				newIns.add(new VarInsnNode(ILOAD, 3));
				newIns.add(new VarInsnNode(ILOAD, 4));
				newIns.add(new MethodInsnNode(INVOKESTATIC, "tes/coremod/TESReplacedMethods$Spawner", "performSpawning_optimised", "(Lnet/minecraft/world/WorldServer;ZZZ)I", false));
				newIns.add(new InsnNode(IRETURN));
				method.instructions.insert(newIns);
				System.out.println("Hummel009: Patched method " + method.name);
			}
