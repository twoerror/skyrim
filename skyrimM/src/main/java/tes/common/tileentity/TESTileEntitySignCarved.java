...
import tes.common.block.other.TESBlockSignCarved;
import tes.common.network.TESPacketHandler;
import tes.common.network.TESPacketOpenSignEditor;
...
public class TESTileEntitySignCarved extends TileEntity {
	...
	public TESTileEntitySignCarved() {
	...
	public void openEditGUI(EntityPlayerMP entityplayer) {
		...
		IMessage packet = new TESPacketOpenSignEditor(this);
	...
	public IIcon getOnBlockIcon() {
		...
		if (block instanceof TESBlockSignCarved) {
			int meta = getBlockMetadata();
			int i = xCoord;
			int j = yCoord;
			int k = zCoord;
			return TESBlockSignCarved.getOnBlockIcon(world, i, j, k, meta);
		}
