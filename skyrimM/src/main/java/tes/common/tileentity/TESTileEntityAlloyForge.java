...
public class TESTileEntityAlloyForge extends TileEntity implements ISidedInventory {
	public static final Collection<CraftingSnapshot> CRAFTING_SNAPSHOTS = new ArrayList<>();

	static {
		CRAFTING_SNAPSHOTS.add(new CraftingSnapshot(new Object[]{TESBlocks.oreCopper, TESItems.copperIngot}, new Object[]{TESBlocks.oreTin, TESItems.tinIngot}, TESItems.bronzeIngot));
		CRAFTING_SNAPSHOTS.add(new CraftingSnapshot(new Object[]{TESBlocks.oreTin, TESItems.tinIngot}, new Object[]{TESBlocks.oreCopper, TESItems.copperIngot}, TESItems.bronzeIngot));


		CRAFTING_SNAPSHOTS.add(new CraftingSnapshot(new Object[]{TESItems.widowWail}, new Object[]{TESItems.oathkeeper}, TESItems.ice));
		CRAFTING_SNAPSHOTS.add(new CraftingSnapshot(new Object[]{TESItems.oathkeeper}, new Object[]{TESItems.widowWail}, TESItems.ice));

		CRAFTING_SNAPSHOTS.add(new CraftingSnapshot(new Object[]{TESItems.cobaltBlue, TESBlocks.oreCobalt}, new Object[]{Blocks.iron_ore, Items.iron_ingot}, TESItems.alloySteelIngot));
		CRAFTING_SNAPSHOTS.add(new CraftingSnapshot(new Object[]{Blocks.iron_ore, Items.iron_ingot}, new Object[]{TESItems.cobaltBlue, TESBlocks.oreCobalt}, TESItems.alloySteelIngot));
	}
	...
	public TESTileEntityAlloyForge() {
		setupForgeSlots();
	}
	...
	public static ItemStack getSmeltingResult(ItemStack itemstack) {
		...
		} else if (item == Items.clay_ball || item == TESItems.redClayBall || item == TESItems.clayMug || item == TESItems.clayPlate || item == TESItems.ceramicPlate) {
			isStoneMaterial = true;
		}
		if (isStoneMaterial || TES.isOreNameEqual(itemstack, "logWood")) {
	...
	public String getForgeName() {
		return StatCollector.translateToLocal("tes.container.alloyForge");
	}
	...
	private void toggleForgeActive() {
		TESBlockForgeBase.toggleForgeActive(worldObj, xCoord, yCoord, zCoord);
	}
	...
	public static class CraftingSnapshot {
		...
		private static ItemStack wrapStack(Object obj) {
			...
			TESLog.getLogger().error("wrapStack");
		...
		private static ItemStack[] wrapStackArray(Object[] objArray) {
			...
			for (int i = 0; i < objArray.length; i++) {
				...
				if (obj instanceof Block) {
					...
					TESLog.getLogger().error("wrapStackArray");
				}
			}
