...
public class TESItemMugTermite extends TESItemMug {
	public TESItemMugTermite(float f) {
		super(f);
	}
	...
	public void addInformation(ItemStack itemstack, EntityPlayer entityplayer, List list, boolean flag) {
		...
		list.add(EnumChatFormatting.DARK_GRAY + StatCollector.translateToLocal("item.tes.drink.explode"));
	}
	...
	public ItemStack onEaten(ItemStack itemstack, World world, EntityPlayer entityplayer) {
		...
		TESLevelData.getData(entityplayer).addAchievement(TESAchievement.drinkTermite);
		return result;
	}
}