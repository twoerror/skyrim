...
public class TESItemPlowcart extends Item {
	public TESItemPlowcart() {
	...
	public ItemStack onItemRightClick(ItemStack itemStackIn, World worldIn, EntityPlayer playerIn) {
		...
		if (result != null && result.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK && !worldIn.isRemote) {
			TESEntityPlowcart cart = new TESEntityPlowcart(worldIn, result.hitVec.xCoord, result.hitVec.yCoord, result.hitVec.zCoord);
