...
public class TESItemTrident extends TESItemPolearm {
	public TESItemTrident(Item.ToolMaterial material) {
		super(material);
	}
			...
			if (!world.isRemote) {
				...
				if (world.rand.nextInt(3) == 0) {
					...
					if (world.rand.nextInt(3) == 0) {
						...
						TESFishing.FishResult result = TESFishing.getFishResult(world.rand, chance, luck, speed, false);
