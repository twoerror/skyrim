...
import tes.client.render.other.TESRenderLingeringDispenser;
import tes.common.entity.other.inanimate.TESEntityLingeringPotion;
...
public class TESItemLingeringPotion extends ItemPotion {
	@SideOnly(Side.CLIENT)
	private IIcon bottle;

	public TESItemLingeringPotion() {
		setCreativeTab(CreativeTabs.tabBrewing);
		BlockDispenser.dispenseBehaviorRegistry.putObject(this, new TESRenderLingeringDispenser());
	}
	...
	public String getItemStackDisplayName(ItemStack stack) {
		...
		String s = StatCollector.translateToLocal("tes.potion").trim() + ' ';
	...
	public ItemStack onItemRightClick(ItemStack stack, World world, EntityPlayer player) {
		...
		if (!world.isRemote) {
			world.spawnEntityInWorld(new TESEntityLingeringPotion(world, player, stack));
		}
		return stack;
	}
