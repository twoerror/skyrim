...
public class TESPacketWeaponFX implements IMessage {
	private Type type;
	private int entityID;

	@SuppressWarnings("unused")
	public TESPacketWeaponFX() {
	}

	public TESPacketWeaponFX(Type t, Entity entity) {
		type = t;
	...
	public static class Handler implements IMessageHandler<TESPacketWeaponFX, IMessage> {
		@Override
		public IMessage onMessage(TESPacketWeaponFX packet, MessageContext context) {
				...
				switch (packet.type) {
					...
					case CHILLING:
						for (int i = 0; i < 40; i++) {
							...
							TES.proxy.spawnParticle("chill", x, d1, z, d3, d4, d5);
						}
						break;
					case INFERNAL:
						for (int i = 0; i < 20; i++) {
