...
import tes.common.network.TESPacketDate;
...
public class TESDate {
	private static final int TICKS_IN_DAY = TESTime.DAY_LENGTH;
	...
	public static void sendUpdatePacket(EntityPlayerMP entityplayer, boolean update) {
		NBTTagCompound nbt = new NBTTagCompound();
		saveDates(nbt);
		IMessage packet = new TESPacketDate(nbt, update);
	...
	public static void setDate(int date) {
		...
		TESLevelData.markDirty();
		FMLLog.info("Updating TES day: " + AegonCalendar.getDate().getDateName(false));
	...
	public static void update(World world) {
		if (!(world.getWorldInfo() instanceof TESWorldInfo)) {
			return;
		}
	...
	public static class AegonCalendar {
		...
		public enum Day {
			...
			private String getDayName() {
				return StatCollector.translateToLocal("tes.date.day." + name);
			}
		}
		...
		public enum Month {
			...
			private String getMonthName() {
				return StatCollector.translateToLocal("tes.date.month." + name);
			}
		...
		public static class Date {
			...
			public String[] getDayAndYearNames(boolean longName) {
				...
				builder.append(' ');
				if (longName) {
					builder.append(StatCollector.translateToLocal("tes.date.long"));
				} else {
					builder.append(StatCollector.translateToLocal("tes.date"));
				}
