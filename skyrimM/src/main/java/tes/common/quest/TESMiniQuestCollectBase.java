...
public abstract class TESMiniQuestCollectBase extends TESMiniQuest {
	protected int amountGiven;

	private int collectTarget;

	protected TESMiniQuestCollectBase(TESPlayerData pd) {
		super(pd);
	}
	...
	public String getQuestProgress() {
		return StatCollector.translateToLocalFormatted("tes.miniquest.collect.progress", amountGiven, collectTarget);
	}

	@Override
	public String getQuestProgressShorthand() {
		return StatCollector.translateToLocalFormatted("tes.miniquest.progressShort", amountGiven, collectTarget);
	}
