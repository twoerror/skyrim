...
public class TESEntityFish extends EntityWaterMob implements TESRandomSkinEntity, TESBiome.ImmuneToFrost, TESBiome.ImmuneToHeat {
	private ChunkCoordinates currentSwimTarget;
	private int swimTargetTime;

	@SuppressWarnings({"WeakerAccess", "unused"})
	public TESEntityFish(World world) {
		super(world);
		setSize(0.5f, 0.5f);
	}
	...
	public IEntityLivingData onSpawnWithEgg(IEntityLivingData data) {
		...
		TESCrashHandler.getBiomeGenForCoords(worldObj, i, k);
