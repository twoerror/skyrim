...
public class TESEntityLingeringEffect extends Entity implements IEntityAdditionalSpawnData {
	...
	public TESEntityLingeringEffect(World world) {
		super(world);
		yOffset = 0;
		setSize(1, 1);
	}
	...
	@SuppressWarnings({"WeakerAccess", "unused"})
	public TESEntityLingeringEffect(World world, TESEntityLingeringPotion potion) {
		this(world, potion.getStack(), potion.getThrower());
		setPosition(potion.posX, potion.posY, potion.posZ);
	}

	@SuppressWarnings({"WeakerAccess", "unused"})
	public TESEntityLingeringEffect(World world, ItemStack stack, EntityLivingBase thrower) {
		this(world);
		this.stack = stack;
	...
	public void applyEntityCollision(Entity e) {
		...
		List<PotionEffect> effects = ((ItemPotion) TESItems.lingeringPotion).getEffects(stack);
