...
public class TESEntitySmokeRing extends EntityThrowable {
	...
	public TESEntitySmokeRing(World world) {
		super(world);
	}

	@SuppressWarnings({"WeakerAccess", "unused"})
	public TESEntitySmokeRing(World world, double d, double d1, double d2) {
		super(world, d, d1, d2);
	}

	@SuppressWarnings({"WeakerAccess", "unused"})
	public TESEntitySmokeRing(World world, EntityLivingBase entityliving) {
