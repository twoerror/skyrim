...
public class TESPlateFallingInfo implements IExtendedEntityProperties {
	...
	private TESPlateFallingInfo(Entity entity) {
		theEntity = entity;
	}

	public static TESPlateFallingInfo getOrCreateFor(Entity entity, boolean create) {
		String propID = "tes_plateFall";
		TESPlateFallingInfo props = (TESPlateFallingInfo) entity.getExtendedProperties(propID);
		if (props == null && create) {
			props = new TESPlateFallingInfo(entity);
