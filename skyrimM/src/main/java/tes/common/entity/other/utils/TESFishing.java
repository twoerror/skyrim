...
public class TESFishing {
	...
	static {
		...
		JUNK.add(new FishingItem(new ItemStack(TESItems.leatherHat), 10));
		...
		JUNK.add(new FishingItem(new ItemStack(TESItems.boneHelmet), 2).setMaxDurability(0.5f));
		JUNK.add(new FishingItem(new ItemStack(TESItems.boneBoots), 2).setMaxDurability(0.5f));
		JUNK.add(new FishingItem(new ItemStack(Items.skull, 1, 0), 5));
		JUNK.add(new FishingItem(new ItemStack(Items.bone), 20));
		JUNK.add(new FishingItem(new ItemStack(TESBlocks.rottenLog, 1, 0), 10));
		...
		JUNK.add(new FishingItem(new ItemStack(TESItems.mug), 10));
		...
		JUNK.add(new FishingItem(new ItemStack(TESItems.saltedFlesh), 5));
		JUNK.add(new FishingItem(new ItemStack(Blocks.waterlily), 15));
		TREASURE.add(new FishingItem(new ItemStack(TESItems.pearl), 200));
		...
		TREASURE.add(new FishingItem(new ItemStack(TESItems.ironDagger), 20).setMaxDurability(0.75f));
		TREASURE.add(new FishingItem(new ItemStack(TESItems.bronzeDagger), 20).setMaxDurability(0.75f));
		TREASURE.add(new FishingItem(new ItemStack(TESItems.coin, 1, 0), 100));
		TREASURE.add(new FishingItem(new ItemStack(TESItems.coin, 1, 1), 10));
		TREASURE.add(new FishingItem(new ItemStack(TESItems.coin, 1, 2), 1));
		TREASURE.add(new FishingItem(new ItemStack(TESItems.pouch, 1, 0), 20));
		TREASURE.add(new FishingItem(new ItemStack(TESItems.pouch, 1, 1), 10));
		TREASURE.add(new FishingItem(new ItemStack(TESItems.pouch, 1, 2), 5));
		TREASURE.add(new FishingItem(new ItemStack(Items.iron_ingot), 20));
		TREASURE.add(new FishingItem(new ItemStack(TESItems.bronzeIngot), 10));
		TREASURE.add(new FishingItem(new ItemStack(TESItems.copperIngot), 10));
		TREASURE.add(new FishingItem(new ItemStack(TESItems.tinIngot), 10));
		...
		TREASURE.add(new FishingItem(new ItemStack(TESItems.silverNugget), 50));
		TREASURE.add(new FishingItem(new ItemStack(TESItems.silverIngot), 5));
		TREASURE.add(new FishingItem(new ItemStack(TESItems.copperRing), 10));
		TREASURE.add(new FishingItem(new ItemStack(TESItems.bronzeRing), 10));
		TREASURE.add(new FishingItem(new ItemStack(TESItems.silverRing), 10));
		TREASURE.add(new FishingItem(new ItemStack(TESItems.goldRing), 5));
	}
