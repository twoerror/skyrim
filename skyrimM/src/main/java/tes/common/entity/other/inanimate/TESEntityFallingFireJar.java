...
public class TESEntityFallingFireJar extends EntityFallingBlock implements IEntityAdditionalSpawnData {
	@SuppressWarnings({"WeakerAccess", "unused"})
	public TESEntityFallingFireJar(World world) {
		super(world);
	}

	@SuppressWarnings({"WeakerAccess", "unused"})
	public TESEntityFallingFireJar(World world, double d, double d1, double d2, Block block) {
		super(world, d, d1, d2, block);
	}

	@SuppressWarnings({"WeakerAccess", "unused"})
	public TESEntityFallingFireJar(World world, double d, double d1, double d2, Block block, int meta) {
