...
public class TESEntitySnowball extends Entity {
	...
	public TESEntitySnowball(World world) {
		super(world);
		setSize(0.3125F, 0.3125F);
	}

	@SuppressWarnings({"WeakerAccess", "unused"})
	public TESEntitySnowball(World world, double d1, double d2, double d3, double d4, double d5, double d6) {
		super(world);
		setSize(0.3125F, 0.3125F);
	...
	@SuppressWarnings({"WeakerAccess", "unused"})
	public TESEntitySnowball(World world, EntityLivingBase entity, double d1, double d2, double d3) {
		super(world);
		double d11 = d1;
		double d21 = d2;
		double d31 = d3;
					...
					if (movingobjectposition.entityHit != null) {
						...
						if (movingobjectposition.entityHit.attackEntityFrom(damagesource, 5.0f)) {
							if (movingobjectposition.entityHit instanceof EntityPlayerMP) {
								TESDamage.doFrostDamage((EntityPlayerMP) movingobjectposition.entityHit);
							}
						} else {
