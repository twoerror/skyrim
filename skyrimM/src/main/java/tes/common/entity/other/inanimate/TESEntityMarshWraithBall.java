...
public class TESEntityMarshWraithBall extends EntityThrowable {
	private Entity attackTarget;
	private int animationTick;

	@SuppressWarnings({"WeakerAccess", "unused"})
	public TESEntityMarshWraithBall(World world) {
		super(world);
		setSize(0.75f, 0.75f);
	}

	@SuppressWarnings({"WeakerAccess", "unused"})
	public TESEntityMarshWraithBall(World world, double d, double d1, double d2) {
		super(world, d, d1, d2);
		setSize(0.75f, 0.75f);
	}

	@SuppressWarnings({"WeakerAccess", "unused"})
	public TESEntityMarshWraithBall(World world, EntityLivingBase entityliving) {
		super(world, entityliving);
		setSize(0.75f, 0.75f);
	}

	public TESEntityMarshWraithBall(World world, EntityLivingBase entityliving, EntityLivingBase target) {
		super(world, entityliving);
		setSize(0.75f, 0.75f);
		attackTarget = target;
