...
public class TESEntityFallingTreasure extends Entity implements IEntityAdditionalSpawnData {
	private Block theBlock;
	private int theBlockMeta;
	private int ticksFalling;

	@SuppressWarnings({"WeakerAccess", "unused"})
	public TESEntityFallingTreasure(World world) {
		super(world);
	}

	@SuppressWarnings({"WeakerAccess", "unused"})
	public TESEntityFallingTreasure(World world, double d, double d1, double d2, Block block) {
		this(world, d, d1, d2, block, 0);
	}

	@SuppressWarnings({"WeakerAccess", "unused"})
	public TESEntityFallingTreasure(World world, double d, double d1, double d2, Block block, int meta) {
		super(world);
