...
public class TESEntityAIRangedAttack extends EntityAIBase {
	...
	public TESEntityAIRangedAttack(IRangedAttackMob entity, double speed, int time, float range) {
		this(entity, speed, time, time, range);
	}

	public TESEntityAIRangedAttack(IRangedAttackMob entity, double speed, int min, int max, float range) {
