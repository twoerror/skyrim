...
public class TESEntityAILionChase extends EntityAIBase {
	private final TESEntityLionBase theLion;
	...
	public TESEntityAILionChase(TESEntityLionBase lion, double d) {
		theLion = lion;
		speed = d;
		setMutexBits(1);
	}
