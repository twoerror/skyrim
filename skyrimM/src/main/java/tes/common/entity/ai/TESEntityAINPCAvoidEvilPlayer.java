...
public class TESEntityAINPCAvoidEvilPlayer extends EntityAIBase {
	...
	public TESEntityAINPCAvoidEvilPlayer(TESEntityNPC npc, float f, double d, double d1) {
		theNPC = npc;
	...
	public boolean shouldExecute() {
		...
		for (EntityPlayer element : list) {
			...
			float alignment = TESLevelData.getData(element).getAlignment(theNPC.getFaction());
