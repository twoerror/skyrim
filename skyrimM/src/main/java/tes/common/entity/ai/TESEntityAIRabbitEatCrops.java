...
import tes.TES;
import tes.common.entity.animal.TESEntityRabbit;
...
public class TESEntityAIRabbitEatCrops extends EntityAIBase {
	private final TESEntityRabbit theRabbit;
	...
	public TESEntityAIRabbitEatCrops(TESEntityRabbit rabbit, double d) {
		theRabbit = rabbit;
		moveSpeed = d;
