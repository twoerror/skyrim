...
public class TESEntityAILionMate extends EntityAIBase {
	private final TESEntityLionBase theAnimal;
	...
	public TESEntityAILionMate(TESEntityLionBase animal, double d) {
		theAnimal = animal;
	...
	private EntityAnimal findMate() {
		...
		Class<? extends EntityAnimal> mateClass = TESEntityLionBase.getAnimalMFBaseClass();
