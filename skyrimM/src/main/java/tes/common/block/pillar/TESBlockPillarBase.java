package tes.common.block.pillar;
...
public abstract class TESBlockPillarBase extends Block {
	...
	private static boolean isPillarAt(IBlockAccess world, int i, int j, int k) {
		...
		return block instanceof TESBlockPillarBase;
	}
