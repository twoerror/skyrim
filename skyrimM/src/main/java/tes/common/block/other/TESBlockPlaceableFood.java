...
public class TESBlockPlaceableFood extends Block {
	...
	public TESBlockPlaceableFood() {
		this(0.4375f, 0.5f);
	}

	public TESBlockPlaceableFood(float f, float f1) {
		super(Material.cake);
		foodHalfWidth = f;
		foodHeight = f1;
		setHardness(0.5f);
	...
	public TESBlockPlaceableFood setFoodStats(int i, float f) {
		healAmount = i;
		saturationAmount = f;
		return this;
	}
