...
public class TESBlockBeacon extends BlockContainer {
	public TESBlockBeacon() {
		super(Material.wood);
	...
	public static boolean isFullyLit(IBlockAccess world, int i, int j, int k) {
		...
		if (tileentity instanceof TESTileEntityBeacon) {
			TESTileEntityBeacon beacon = (TESTileEntityBeacon) tileentity;
	...
	public TileEntity createNewTileEntity(World world, int i) {
		return new TESTileEntityBeacon();
	}
	...
	public int getRenderType() {
		return TES.proxy.getBeaconRenderID();
	}
	...
	//			TESLevelData.getData(entityplayer).addAchievement(TESAchievement.lightBeacon);
			}
			return true;
		}
