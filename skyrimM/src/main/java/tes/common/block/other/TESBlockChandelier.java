...
public class TESBlockChandelier extends Block {
	...
	public boolean canBlockStay(World world, int i, int j, int k) {
		...
		return block instanceof BlockFence || block instanceof BlockWall || block instanceof BlockSlab && !block.isOpaqueCube() && (meta & 8) == 0 || block instanceof BlockStairs && (meta & 4) == 0 || block instanceof TESBlockChain || world.getBlock(i, j + 1, k).isSideSolid(world, i, j + 1, k, ForgeDirection.DOWN);
	}
