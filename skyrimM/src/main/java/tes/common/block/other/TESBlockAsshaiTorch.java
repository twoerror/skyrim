...
public class TESBlockAsshaiTorch extends BlockTorch {
	public TESBlockAsshaiTorch() {
	...
	private static class TorchParticle {
		...
		private void spawn(double x, double y, double z) {
			TES.proxy.spawnParticle(name, x + posX, y + posY, z + posZ, motionX, motionY, motionZ);
		}
	}
}