...
public class TESBlockWeaponRack extends BlockContainer {
	public TESBlockWeaponRack() {
	...
	public void breakBlock(World world, int i, int j, int k, Block block, int meta) {
		...
		TESTileEntityWeaponRack rack = (TESTileEntityWeaponRack) world.getTileEntity(i, j, k);
	...
	public TileEntity createNewTileEntity(World world, int i) {
		return new TESTileEntityWeaponRack();
	}
	...
	public boolean onBlockActivated(World world, int i, int j, int k, EntityPlayer entityplayer, int side, float f, float f1, float f2) {
		...
		if (tileentity instanceof TESTileEntityWeaponRack) {
			TESTileEntityWeaponRack rack = (TESTileEntityWeaponRack) tileentity;
			...
			if (TESTileEntityWeaponRack.canAcceptItem(heldItem)) {
				if (!world.isRemote) {
