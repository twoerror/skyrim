...
public class TESBlockChain extends Block {
	...
	public boolean canPlaceBlockAt(World world, int i, int j, int k) {
		...
		return block instanceof TESBlockChain || block instanceof BlockFence || block instanceof BlockWall || block instanceof BlockSlab && !block.isOpaqueCube() && (meta & 8) == 0 || block instanceof BlockStairs && (meta & 4) == 0 || world.getBlock(i, j + 1, k).isSideSolid(world, i, j + 1, k, ForgeDirection.DOWN);
	}
	...
	public IIcon getIcon(IBlockAccess world, int i, int j, int k, int side) {
		...
		boolean chainAbove = above instanceof TESBlockChain;
		boolean chainBelow = below instanceof TESBlockChain || below instanceof TESBlockChandelier;
	...
	public int getRenderType() {
		return TES.proxy.getChainRenderID();
	}
