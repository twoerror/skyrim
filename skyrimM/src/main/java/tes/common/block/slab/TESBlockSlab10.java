...
public class TESBlockSlab10 extends TESBlockSlabBase {
	public TESBlockSlab10(boolean hidden) {
	...
	public IIcon getIcon(int i, int j) {
		...
		switch (j1) {
			case 0:
				return TESBlocks.pillar2.getIcon(i, 5);
			case 1:
			...
			case 4:
				return TESBlocks.pillar2.getIcon(i, 6);
			case 5:
				return TESBlocks.pillar2.getIcon(i, 7);
			case 6:
