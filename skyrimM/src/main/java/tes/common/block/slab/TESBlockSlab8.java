...
public class TESBlockSlab8 extends TESBlockSlabBase {
	public TESBlockSlab8(boolean hidden) {
	...
	public IIcon getIcon(int i, int j) {
		...
		switch (j1) {
			...
			case 5:
				return TESBlocks.pillar1.getIcon(i, 14);
			case 6:
				return TESBlocks.brick4.getIcon(i, 14);
			case 7:
				return TESBlocks.smoothStone.getIcon(i, 5);
			default:
				return null;
		}
	}
