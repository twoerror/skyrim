...
public class TESBlockSlab2 extends TESBlockSlabBase {
	public TESBlockSlab2(boolean hidden) {
	...
	public IIcon getIcon(int i, int j) {
		...
		switch (j1) {
			case 0:
				return TESBlocks.smoothStone.getIcon(i, 6);
			case 1:
				return TESBlocks.smoothStone.getIcon(i, 2);
			case 2:
				return TESBlocks.brick1.getIcon(i, 7);
			case 3:
				return TESBlocks.pillar2.getIcon(i, 0);
			case 4:
