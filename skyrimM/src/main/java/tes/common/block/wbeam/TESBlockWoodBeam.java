package tes.common.block.wbeam;
...
public abstract class TESBlockWoodBeam extends BlockRotatedPillar {
	...
	public int getRenderType() {
		return TES.proxy.getBeamRenderID();
	}
