...
public class TESGenLayerSmooth extends TESGenLayer {
	public TESGenLayerSmooth(long l, TESGenLayer layer) {
		super(l);
		tesParent = layer;
	}
	...
	public int[] getInts(World world, int i, int k, int xSize, int zSize) {
		...
		int xSizeP = xSize + 2;
		int zSizeP = zSize + 2;
		int[] biomes = tesParent.getInts(world, i1, k1, xSizeP, zSizeP);
