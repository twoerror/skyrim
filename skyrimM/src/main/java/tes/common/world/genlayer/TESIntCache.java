...
public class TESIntCache {
	private static final TESIntCache SERVER = new TESIntCache();
	private static final TESIntCache CLIENT = new TESIntCache();
	...
	public static TESIntCache get(World world) {
		if (!world.isRemote) {
			return SERVER;
		}
		return CLIENT;
