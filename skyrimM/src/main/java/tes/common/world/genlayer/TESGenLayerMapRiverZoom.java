...
public class TESGenLayerMapRiverZoom extends TESGenLayer {
	public TESGenLayerMapRiverZoom(long l, TESGenLayer layer) {
		super(l);
		tesParent = layer;
	}
	...
	public int[] getInts(World world, int i, int k, int xSize, int zSize) {
		...
		int[] rivers = tesParent.getInts(world, i1, k1, xSizeZoom, zSizeZoom);
