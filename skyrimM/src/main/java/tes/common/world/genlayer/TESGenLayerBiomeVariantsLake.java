...
public class TESGenLayerBiomeVariantsLake extends TESGenLayer {
	private final int zoomScale;
	private int lakeFlags;

	public TESGenLayerBiomeVariantsLake(long l, TESGenLayer layer, int i) {
		super(l);
		tesParent = layer;
	...
	public int[] getInts(World world, int i, int k, int xSize, int zSize) {
		int[] baseInts = tesParent == null ? null : tesParent.getInts(world, i, k, xSize, zSize);
	...
	public TESGenLayerBiomeVariantsLake setLakeFlags(int... flags) {
		for (int f : flags) {
