...
public class TESGenLayerNarrowRivers extends TESGenLayer {
	private final int maxRange;

	public TESGenLayerNarrowRivers(long l, TESGenLayer layer, int r) {
		super(l);
		tesParent = layer;
		maxRange = r;
	}
	...
	public int[] getInts(World world, int i, int k, int xSize, int zSize) {
		int[] rivers = tesParent.getInts(world, i - maxRange, k - maxRange, xSize + maxRange * 2, zSize + maxRange * 2);
