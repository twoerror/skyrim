...
import tes.common.world.feature.*;
...
public class TESBiomeDecorator {
	private final Collection<TESTreeType.WeightedTreeType> treeTypes = new HashSet<>();
	//private final Collection<TESStructureBaseSettlement> settlements = new HashSet<>();
	//private final Collection<TESStructureBaseSettlement> fixedSettlements = new HashSet<>();
	...
	private final WorldGenerator sandGen = new TESWorldGenSand(Blocks.sand, 7, 2);
	private final WorldGenerator whiteSandGen = new TESWorldGenSand(TESBlocks.whiteSand, 7, 2);
	private final WorldGenerator quagmireGen = new TESWorldGenSand(TESBlocks.quagmire, 7, 2);
	private final WorldGenerator surfaceGravelGen = new TESWorldGenSurfaceGravel();
	private final WorldGenerator flowerGen = new TESWorldGenBiomeFlowers();
	private final WorldGenerator logGen = new TESWorldGenLogs();
	private final WorldGenerator caneGen = new WorldGenReed();
	private final WorldGenerator reedGen = new TESWorldGenReeds(TESBlocks.reeds);
	private final WorldGenerator dryReedGen = new TESWorldGenReeds(TESBlocks.driedReeds);
	private final WorldGenerator cornGen = new TESWorldGenCorn();
	...
	private WorldGenerator clayGen = new TESWorldGenSand(Blocks.clay, 5, 1);
	private WorldGenerator stalactiteGen = new TESWorldGenStalactites(TESBlocks.stalactite);
	...
	public TESBiomeDecorator(TESBiome tesbiome) {
		biome = tesbiome;
		addDefaultOres();
	}
	...
	private void addDefaultOres() {
		...
		addSoil(new WorldGenMinable(TESBlocks.rock, 0, 12, Blocks.stone), 30.0f, 0, 10);
		addSoil(new WorldGenMinable(TESBlocks.rock, 1, 12, Blocks.stone), 30.0f, 0, 64);
		addSoil(new WorldGenMinable(TESBlocks.rock, 2, 12, Blocks.stone), 30.0f, 0, 64);
		addSoil(new WorldGenMinable(TESBlocks.rock, 3, 12, Blocks.stone), 30.0f, 0, 64);
		addSoil(new WorldGenMinable(TESBlocks.rock, 4, 12, Blocks.stone), 30.0f, 0, 64);
		addSoil(new WorldGenMinable(TESBlocks.rock, 5, 12, Blocks.stone), 30.0f, 0, 64);
		addSoil(new WorldGenMinable(TESBlocks.rock, 6, 12, Blocks.stone), 30.0f, 0, 64);
		addOre(new WorldGenMinable(TESBlocks.oreCopper, 8), 15.0f, 0, 128);
		addOre(new WorldGenMinable(TESBlocks.oreTin, 8), 15.0f, 0, 128);
		addOre(new WorldGenMinable(Blocks.coal_ore, 16), 40.0f, 0, 128);
		addOre(new WorldGenMinable(Blocks.iron_ore, 8), 20.0f, 0, 64);
		addOre(new WorldGenMinable(TESBlocks.oreSulfur, 8), 2.0f, 0, 64);
		addOre(new WorldGenMinable(TESBlocks.oreSaltpeter, 8), 2.0f, 0, 64);
		addOre(new WorldGenMinable(TESBlocks.oreSalt, 12), 2.0f, 0, 64);

		/* Зарегулированные пропорциональные цены */
		addOre(new WorldGenMinable(TESBlocks.oreSilver, 4), 8.0f, 0, 32);
		addOre(new WorldGenMinable(Blocks.gold_ore, 4), 2.0f, 0, 32);
		addGem(new WorldGenMinable(TESBlocks.oreGem, 5, 4, Blocks.stone), 2.0f, 0, 32);
		addGem(new WorldGenMinable(TESBlocks.oreGem, 7, 4, Blocks.stone), 3.0f, 0, 32);
		addGem(new WorldGenMinable(TESBlocks.oreGem, 0, 4, Blocks.stone), 4.0f, 0, 32);
		addGem(new WorldGenMinable(TESBlocks.oreGem, 1, 4, Blocks.stone), 4.0f, 0, 32);
		addGem(new WorldGenMinable(TESBlocks.oreGem, 2, 4, Blocks.stone), 4.0f, 0, 32);
		addGem(new WorldGenMinable(TESBlocks.oreGem, 3, 4, Blocks.stone), 4.0f, 0, 32);
		addGem(new WorldGenMinable(TESBlocks.oreGem, 4, 4, Blocks.stone), 4.0f, 0, 32);
		addGem(new WorldGenMinable(TESBlocks.oreGem, 6, 4, Blocks.stone), 4.0f, 0, 32);
	}

	//public void addFixedSettlement(TESStructureBaseSettlement settlement) {
	...
	//public void addSettlement(TESStructureBaseSettlement settlement) {
	//	settlements.add(settlement);
	//}
	...
	public void addTree(TESTreeType type, int weight) {
		treeTypes.add(new TESTreeType.WeightedTreeType(type, weight));
	}

	public boolean anyFixedSettlementsAt(World world, int i, int k) {
//		for (TESStructureBaseSettlement settlement : fixedSettlements) {
...
//	public void clearSettlements() {
	...
	private void decorate() {
		...
		int j5;
		int k7;
		TESBiomeVariant biomeVariant = ((TESWorldChunkManager) worldObj.getWorldChunkManager()).getBiomeVariantAt(chunkX + 8, chunkZ + 8);
		generateOres();
		...
		if (!biomeVariant.isDisableStructures() && Math.abs(chunkX) > 32 && Math.abs(chunkZ) > 32) {
			...
			boolean roadNear = TESBeziers.isBezierNear(chunkX + 8, chunkZ + 8, 16, TESBeziers.Type.ROAD) >= 0.0f;
			boolean wallNear = TESBeziers.isBezierNear(chunkX + 8, chunkZ + 8, 16, TESBeziers.Type.WALL) >= 0.0f;
			boolean linkerNear = TESBeziers.isBezierNear(chunkX + 8, chunkZ + 8, 16, TESBeziers.Type.LINKER) >= 0.0f;
		...
		if (trees > 0) {
			...
			while (l3 < fallenLeaves) {
				...
				new TESWorldGenFallenLeaves().generate(worldObj, rand, i5, worldObj.getTopSolidOrLiquidBlock(i5, k4), k4);
				++l3;
			}
			...
			while (l3 < bushes) {
				i5 = chunkX + rand.nextInt(16) + 8;
				k4 = chunkZ + rand.nextInt(16) + 8;
				new TESWorldGenBushes().generate(worldObj, rand, i5, worldObj.getTopSolidOrLiquidBlock(i5, k4), k4);
				++l3;
			}
		}
		...
		if (flowersPerChunk > 0 && rand.nextInt(4) == 0) {
			...
			j3 = rand.nextInt(128);
			k5 = chunkZ + rand.nextInt(16) + 8;
			new TESWorldGenBerryBush().generate(worldObj, rand, i5, j3, k5);
		}
		if (generateAgriculture && rand.nextInt(6) == 0) {
			i5 = chunkX + rand.nextInt(16) + 8;
			j3 = rand.nextInt(128);
			k5 = chunkZ + rand.nextInt(16) + 8;
			new WorldGenFlowers(TESBlocks.pipeweedPlant).generate(worldObj, rand, i5, j3, k5);
		}
		if (generateAgriculture && rand.nextInt(6) == 0) {
			i5 = chunkX + rand.nextInt(16) + 8;
			j3 = rand.nextInt(128);
			k5 = chunkZ + rand.nextInt(16) + 8;
			new WorldGenFlowers(TESBlocks.flaxPlant).generate(worldObj, rand, i5, j3, k5);
		}
	}
	...
	public void decorate(World world, Random random, int i, int k) {
		...
		decorate();
		if (!disableLocations) {
			TESFixer.addSpecialLocations(world, random, i, k);
		}
	}
	...
	public TESTreeType getRandomTreeForVariant(Random random, TESBiomeVariant variant) {
	...
	public int getVariantTreesPerChunk(TESBiomeVariant variant) {
