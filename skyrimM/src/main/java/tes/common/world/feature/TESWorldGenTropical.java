...
public class TESWorldGenTropical extends WorldGenAbstractTree {
	...
	public TESWorldGenTropical setExtraTrunkWidth(int i) {
		extraTrunkWidth = i;
		return this;
	}
}