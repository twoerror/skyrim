...
public class TESWorldGenAspen extends WorldGenAbstractTree {
	private Block woodBlock = TESBlocks.wood7;
	private Block leafBlock = TESBlocks.leaves7;
	...
	public TESWorldGenAspen(boolean flag) {
		super(flag);
	}
	...
	public TESWorldGenAspen setBlocks(Block b1, int m1, Block b2, int m2) {
		woodBlock = b1;
		woodMeta = m1;
		leafBlock = b2;
		leafMeta = m2;
	...
	public TESWorldGenAspen setExtraTrunkWidth(int w) {
		extraTrunk = w;
		return this;
	}

	public TESWorldGenAspen setMinMaxHeight(int min, int max) {
		minHeight = min;
		maxHeight = max;
		return this;
	}
