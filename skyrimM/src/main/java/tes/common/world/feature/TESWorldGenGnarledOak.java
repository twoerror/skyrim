...
public class TESWorldGenGnarledOak extends WorldGenAbstractTree {
	...
	public TESWorldGenGnarledOak(boolean flag) {
		super(flag);
	}
	...
	public TESWorldGenGnarledOak setMinMaxHeight(int min, int max) {
		minHeight = min;
		maxHeight = max;
		return this;
	}
