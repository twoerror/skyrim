...
public class TESWorldGenUlthosOak extends WorldGenAbstractTree {
	private final int minHeight;
	private final int maxHeight;
	private final int trunkWidth;
	private final boolean isMirky;
	private boolean isDead;
	private Block woodBlock = TESBlocks.wood1;
	private int woodMeta = 2;
	private Block leafBlock = TESBlocks.leaves1;
	private int leafMeta = 2;

	public TESWorldGenUlthosOak(boolean flag, int i, int j, int k, boolean mirk) {
		super(flag);
		minHeight = i;
		maxHeight = j;
		trunkWidth = k;
	...
	private void growVines(World world, Random random, int i, int j, int k, int meta) {
		int j1 = j;
		setBlockAndNotifyAdequately(world, i, j1, k, TESBlocks.mirkVines, meta);
	...
	private TESWorldGenUlthosOak setBlocks(Block b1, int m1, Block b2, int m2) {
		woodBlock = b1;
		woodMeta = m1;
		leafBlock = b2;
		leafMeta = m2;
	...
	public TESWorldGenUlthosOak setDead() {
		isDead = true;
		return this;
	}

	public TESWorldGenUlthosOak setGreenOak() {
		return setBlocks(TESBlocks.wood7, 1, TESBlocks.leaves7, 1);
	}

	public TESWorldGenUlthosOak setRedOak() {
		return setBlocks(TESBlocks.wood7, 1, TESBlocks.leaves1, 3);
	}
}