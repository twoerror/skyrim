...
public class TESWorldGenCharredTrees extends WorldGenAbstractTree {
	public TESWorldGenCharredTrees() {
		super(false);
	}
	...
	public boolean generate(World world, Random random, int i, int j, int k) {
		...
		for (int j1 = j; j1 < j + height; ++j1) {
			world.setBlock(i, j1, k, TESBlocks.wood1, 3, 2);
		}
		if (height >= 4) {
			for (int branch = 0; branch < 4; ++branch) {
				...
				for (int l = 0; l < branchLength; ++l) {
					...
					switch (branch) {
						case 0:
							world.setBlock(i - branchHorizontalPos, branchVerticalPos, k, TESBlocks.wood1, 15, 2);
							continue;
						case 1:
							world.setBlock(i, branchVerticalPos, k + branchHorizontalPos, TESBlocks.wood1, 15, 2);
							continue;
						case 2:
							world.setBlock(i + branchHorizontalPos, branchVerticalPos, k, TESBlocks.wood1, 15, 2);
							continue;
