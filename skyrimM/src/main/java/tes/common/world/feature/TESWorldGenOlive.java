...
public class TESWorldGenOlive extends WorldGenAbstractTree {
	private Block woodBlock = TESBlocks.wood6;
	private Block leafBlock = TESBlocks.leaves6;
	...
	public TESWorldGenOlive(boolean flag) {
		super(flag);
	}
	...
	public TESWorldGenOlive setBlocks(Block b1, int m1, Block b2, int m2) {
		woodBlock = b1;
		woodMeta = m1;
		leafBlock = b2;
		leafMeta = m2;
	...
	public TESWorldGenOlive setExtraTrunkWidth(int w) {
		extraTrunk = w;
		return this;
	}

	public TESWorldGenOlive setMinMaxHeight(int min, int max) {
		minHeight = min;
		maxHeight = max;
		return this;
	}
