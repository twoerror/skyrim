...
public class TESWorldGenCedar extends WorldGenAbstractTree {
	private Block woodBlock = TESBlocks.wood4;
	private Block leafBlock = TESBlocks.leaves4;
	...
	public TESWorldGenCedar(boolean flag) {
		super(flag);
	}
	...
	public TESWorldGenCedar setBlocks(Block b1, int m1, Block b2, int m2) {
		woodBlock = b1;
		woodMeta = m1;
		leafBlock = b2;
		leafMeta = m2;
	...
	public TESWorldGenCedar setHangingLeaves() {
		hangingLeaves = true;
		return this;
	}

	public TESWorldGenCedar setMinMaxHeight(int min, int max) {
		minHeight = min;
		maxHeight = max;
		return this;
	}
