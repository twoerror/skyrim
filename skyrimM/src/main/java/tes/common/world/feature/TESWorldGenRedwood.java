...
public class TESWorldGenRedwood extends WorldGenAbstractTree {
	private static final Block WOOD_BLOCK = TESBlocks.wood8;
	private static final Block LEAF_BLOCK = TESBlocks.leaves8;
	private int trunkWidth;
	private int extraTrunkWidth;

	public TESWorldGenRedwood(boolean flag) {
		super(flag);
	}
	...
	public TESWorldGenRedwood setTrunkWidth(int i) {
		trunkWidth = i;
		return this;
	}

	public TESWorldGenRedwood setExtraTrunkWidth(int i) {
		extraTrunkWidth = i;
		return this;
	}
}