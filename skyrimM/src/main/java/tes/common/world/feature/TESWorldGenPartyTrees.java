...
public class TESWorldGenPartyTrees extends WorldGenAbstractTree {
	...
	public TESWorldGenPartyTrees(Block block, int i, Block block1, int j) {
		super(false);
		woodBlock = block;
		woodMeta = i;
		leafBlock = block1;
	...
	public TESWorldGenPartyTrees disableRestrictions() {
		restrictions = false;
		return this;
	}
