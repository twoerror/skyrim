...
public class TESWorldGenPine extends WorldGenAbstractTree {
	private static final Block WOOD_BLOCK = TESBlocks.wood5;
	private static final Block LEAF_BLOCK = TESBlocks.leaves5;
	private static final int WOOD_META = 0;
	private static final int LEAF_META = 0;

	public TESWorldGenPine(boolean flag) {
		super(flag);
	}
