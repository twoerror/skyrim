...
public class TESWorldGenIbbenPine extends WorldGenAbstractTree {
	private static final Block WOOD_BLOCK = TESBlocks.wood1;
	private static final Block LEAF_BLOCK = TESBlocks.leaves1;
	private static final int WOOD_META = 0;
	private static final int LEAF_META = 0;

	public TESWorldGenIbbenPine(boolean flag) {
		super(flag);
	}
