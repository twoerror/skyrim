...
public class TESWorldGenFallenLeaves extends WorldGenerator {
	@Override
	public boolean generate(World world, Random random, int i, int j, int k) {
		...
		for (l = 0; l < 40; ++l) {
			...
			if (!(block instanceof BlockLeavesBase) || (obj = TESBlockFallenLeaves.fallenBlockMetaFromLeafBlockMeta(block, world.getBlockMetadata(i1, j1, k1))) == null) {
				continue;
			}
