...
public class TESContainerChestWithPouch extends ContainerChest {
	private final IInventory chestInv;
	private final TESContainerPouch pouchContainer;
	private final int thePouchSlot;
	private final int numChestRows;
	private final int numPouchRows;

	public TESContainerChestWithPouch(EntityPlayer entityplayer, int pouchSlot, IInventory chest) {
		...
		pouchContainer = new TESContainerPouch(entityplayer, thePouchSlot);
	...
	public ItemStack slotClick(int slotNo, int subActionNo, int actionNo, EntityPlayer entityplayer) {
		if (TESContainerPouch.isPouchSlot(this, slotNo, entityplayer, thePouchSlot) || actionNo == 2 && subActionNo == thePouchSlot) {
			return null;
		}
	...
	public TESContainerPouch getPouchContainer() {
