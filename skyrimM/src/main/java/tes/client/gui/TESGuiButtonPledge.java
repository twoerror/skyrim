...
public class TESGuiButtonPledge extends GuiButton {
	private final TESGuiFactions parentGUI;

	private List<String> displayLines;

	private boolean isBroken;

	public TESGuiButtonPledge(TESGuiFactions gui, int i, int x, int y, String s) {
		super(i, x, y, 32, 32, s);
		parentGUI = gui;
	}
