...
public class TESGuiMessage extends TESGuiScreenBase {
	private static final ResourceLocation GUI_TEXTURE = new ResourceLocation("tes:textures/gui/message.png");

	private static final int X_SIZE = 240;
	private static final int Y_SIZE = 160;

	private final TESGuiMessageTypes type;
	...
	public TESGuiMessage(TESGuiMessageTypes t) {
		type = t;
	}
	...
	public void drawScreen(int i, int j, float f) {
		...
		String s = StatCollector.translateToLocal("tes.gui.message.notDisplayedAgain");
	...
	public void initGui() {
		...
		buttonDismiss = new TESGuiButton(0, guiLeft + X_SIZE / 2 - 40, guiTop + Y_SIZE + 20, 80, 20, StatCollector.translateToLocal("tes.gui.message.dismiss"));
