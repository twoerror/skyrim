...
public class TESGuiHiredInteract extends TESGuiNPCInteract {
	public TESGuiHiredInteract(TESEntityNPC entity) {
		super(entity);
	}
	...
	@Override
	public void initGui() {
		buttonList.add(new TESGuiButton(0, width / 2 - 65, height / 5 * 3, 60, 20, StatCollector.translateToLocal("tes.gui.npc.talk")));
		buttonList.add(new TESGuiButton(1, width / 2 + 5, height / 5 * 3, 60, 20, StatCollector.translateToLocal("tes.gui.npc.command")));
