...
public class TESGuiButton extends GuiButton {
	public TESGuiButton(int i, int x, int y, int w, int h, String s) {
		super(i, x, y, w, h, s);
	}

	public TESGuiButton(int i, int x, int y, String s) {
		this(i, x, y, 200, 20, s);
	}
	...
	public void drawButton(Minecraft mc, int i, int j) {
		if (visible) {
			...
			mc.getTextureManager().bindTexture(new ResourceLocation("tes:textures/gui/buttons.png"));
