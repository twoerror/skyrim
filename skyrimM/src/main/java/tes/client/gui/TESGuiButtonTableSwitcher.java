...
public class TESGuiButtonTableSwitcher extends GuiButton {
	private static final RenderItem ITEM_RENDERER = new RenderItem();

	private final Block table;

	public TESGuiButtonTableSwitcher(int i, int x, int y, String s, Block table) {
		super(i, x, y, 16, 16, s);
		this.table = table;
	}
	...
	public void drawButton(Minecraft mc, int i, int j) {
		Block block = TESLevelData.getData(mc.thePlayer).getTableSwitched() ? table : Blocks.crafting_table;
		if (!func_146115_a()) {
