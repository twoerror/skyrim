...
import tes.common.network.TESPacketEditSign;
...
public class TESGuiEditSign extends GuiScreen {
	private static final RenderItem ITEM_RENDERER = new RenderItem();

	private final TESTileEntitySignCarved tileSign;
	...
	public TESGuiEditSign(TESTileEntitySignCarved sign) {
		tileSign = sign;
	}
	...
	public void initGui() {
		...
		buttonDone = new TESGuiButton(0, width / 2 - 100, height / 4 + 120, StatCollector.translateToLocal("gui.done"));
	...
	public void onGuiClosed() {
		...
		IMessage packet = new TESPacketEditSign(tileSign);
