...
public class TESGuiButtonIronBank extends GuiButton {
	public TESGuiButtonIronBank(int id, int x, int y) {
		super(id, x, y, 28, 28, "");
	}
	...
	public void drawButton(Minecraft mc, int mousex, int mousey) {
		if (visible) {
			...
			mc.getTextureManager().bindTexture(new ResourceLocation("tes:textures/gui/transparent.png"));
