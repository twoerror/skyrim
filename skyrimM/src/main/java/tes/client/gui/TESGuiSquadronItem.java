...
import tes.common.network.TESPacketItemSquadron;
...
public class TESGuiSquadronItem extends TESGuiScreenBase {
	private static final ResourceLocation GUI_TEXTURE = new ResourceLocation("tes:textures/gui/squadronItem.png");
	...
	public void drawScreen(int i, int j, float f) {
		...
		s = StatCollector.translateToLocal("tes.gui.squadronItem.squadron");
		...
		if (noSquadron) {
			String squadronMessage = StatCollector.translateToLocal("tes.gui.squadronItem.none");
	...
	public void initGui() {
		...
		buttonDone = new TESGuiButton(1, guiLeft + X_SIZE / 2 - 40, guiTop + 85, 80, 20, StatCollector.translateToLocal("tes.gui.squadronItem.done"));
		...
		if (itemstack != null && itemstack.getItem() instanceof TESSquadrons.SquadronItem) {
			...
			String squadron = TESSquadrons.getSquadron(theItem);
	...
	public void onGuiClosed() {
		...
		IMessage packet = new TESPacketItemSquadron(squadron);
