...
import tes.client.model.TESModelCargocart;
...
public class TESRenderCargocart extends Render {
	private static final ResourceLocation TEXTURE = new ResourceLocation("tes:textures/model/cargocart.png");
	private static final ModelBase MODEL = new TESModelCargocart();

	public TESRenderCargocart() {
