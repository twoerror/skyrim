...
public class TESConnectedTextures {
	private static final Map<String, Map<Integer, IIcon>> BLOCK_ICONS_MAP = new HashMap<>();
	private static final Minecraft MINECRAFT = Minecraft.getMinecraft();

	private TESConnectedTextures() {
	}

	private static void createConnectedIcons(IIconRegister iconregister, TESConnectedBlock block, int meta, boolean includeNoBase, Map<IconElement, BufferedImage> iconElementMap) {
	...
	public static IIcon getConnectedIconBlock(TESConnectedBlock block, IBlockAccess world, int i, int j, int k, int side, boolean noBase) {
	...
	public static IIcon getConnectedIconItem(TESConnectedBlock block, int meta) {
		String blockName = block.getConnectedName(meta);
	...
	public static IIcon getConnectedIconItem(TESConnectedBlock block, int meta, boolean[][] adjacentFlags) {
		String blockName = block.getConnectedName(meta);
	...
	public static void registerConnectedIcons(IIconRegister iconregister, TESConnectedBlock block, int meta, boolean includeNoBase) {
	...
	public static void registerNonConnectedGateIcons(IIconRegister iconregister, TESConnectedBlock block, int meta) {
		registerNonConnectedGateIcons(iconregister, block, meta, block.getConnectedName(meta));
	}

	private static void registerNonConnectedGateIcons(IIconRegister iconregister, TESConnectedBlock block, int meta, String iconName) {
		IResourceManager resourceManager = MINECRAFT.getResourceManager();
		String baseIconName = getBaseIconName(iconName);
		String modID = getModID(iconName);
		Map<IconElement, BufferedImage> iconElementMap = new EnumMap<>(IconElement.class);
