...
public class TESRenderSignCarved extends TileEntitySpecialRenderer implements IResourceManagerReloadListener {
	...
	protected int getTextColor(TESTileEntitySignCarved sign, float f) {
	...
	public void renderTileEntityAt(TileEntity tileentity, double d, double d1, double d2, float f) {
		TESTileEntitySignCarved sign = (TESTileEntitySignCarved) tileentity;
