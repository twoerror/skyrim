...
import tes.client.model.TESModelWeaponRack;
import tes.common.tileentity.TESTileEntityWeaponRack;
...
public class TESRenderWeaponRack extends TileEntitySpecialRenderer {
	private static final ResourceLocation RACK_TEXTURE = new ResourceLocation("tes:textures/model/weapon_rack.png");
	private static final TESModelWeaponRack RACK_MODEL = new TESModelWeaponRack();

	@Override
	public void renderTileEntityAt(TileEntity tileentity, double d, double d1, double d2, float f) {
		TESTileEntityWeaponRack weaponRack = (TESTileEntityWeaponRack) tileentity;
		GL11.glPushMatrix();
		GL11.glDisable(2884);
		GL11.glEnable(32826);
		GL11.glEnable(3008);
		...
		if (weaponItem != null) {
			...
			TESRenderBow.setRenderingWeaponRack(true);
			...
			TESRenderBow.setRenderingWeaponRack(false);
		}
		GL11.glEnable(2884);
	...
	private void renderWeaponName(TESTileEntityWeaponRack rack, double d, double d1, double d2) {
