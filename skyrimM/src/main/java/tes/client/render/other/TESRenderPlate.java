...
public class TESRenderPlate extends Render {
	private static final RenderBlocks BLOCK_RENDERER = new RenderBlocks();

	@Override
	public void doRender(Entity entity, double d, double d1, double d2, float f, float f1) {
		TESEntityPlate plate = (TESEntityPlate) entity;
		GL11.glEnable(32826);
		GL11.glPushMatrix();
		...
		TESRenderBlocks.renderEntityPlate(plate.getPlateBlock(), BLOCK_RENDERER);
		GL11.glPopMatrix();
