...
import tes.client.render.animal.TESRenderBird;
...
public class TESRenderAnimalJar extends TileEntitySpecialRenderer implements IItemRenderer {
	@Override
	...
	public void renderItem(IItemRenderer.ItemRenderType type, ItemStack itemstack, Object... data) {
		...
		Entity jarEntity = TESItemAnimalJar.getItemJarEntity(itemstack, viewer.worldObj);
		if (jarEntity != null) {
			...
			if (type == IItemRenderer.ItemRenderType.ENTITY) {
				TESRenderBird.setRenderStolenItem(false);
			}
			RenderManager.instance.renderEntityWithPosYaw(jarEntity, 0.0, 0.0, 0.0, 0.0f, TESTickHandlerClient.getRenderTick());
			TESRenderBird.setRenderStolenItem(true);
			GL11.glPopAttrib();
			GL11.glPopMatrix();
		}
		GL11.glEnable(3008);
