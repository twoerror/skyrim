...
public class TESRenderSkullStaff implements IItemRenderer {
	...
	private static final ResourceLocation STAFF_TEXTURE = new ResourceLocation("tes:textures/model/skull_staff.png");
