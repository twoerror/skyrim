...
public class TESRenderLingeringPotion extends RenderSnowball {
	public TESRenderLingeringPotion() {
		super(TESItems.lingeringPotion);
	}
	...
	public void doRender(Entity entity, double x, double y, double z, float p_76986_8_, float p_76986_9_) {
		if (!(entity instanceof TESEntityLingeringPotion)) {
			return;
		}
		ItemStack stack = ((TESEntityLingeringPotion) entity).getStack();
