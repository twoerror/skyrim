...
public class TESWeatherRenderer extends IRenderHandler {
	private static final ResourceLocation RAIN_TEXTURE = new ResourceLocation("tes:textures/weather/rain.png");
	private static final ResourceLocation SNOW_TEXTURE = new ResourceLocation("tes:textures/weather/snow.png");
	private static final ResourceLocation SANDSTORM_TEXTURE = new ResourceLocation("tes:textures/weather/sandstorm.png");
	...
	public static boolean isSandstormBiome(BiomeGenBase biome) {
		return biome instanceof TESBiome.Desert || biome.topBlock.getMaterial() == Material.sand;
	}

	@Override
	public void render(float partialTicks, WorldClient world, Minecraft mc) {
		EntityRenderer er = mc.entityRenderer;
		int rendererUpdateCount = TESTickHandlerClient.getClientTick();
		...
		if (rainStrength > 0.0f) {
			...
			for (int l = i3 - b0; l <= i3 + b0; ++l) {
				for (int i1 = k2 - b0; i1 <= k2 + b0; ++i1) {
					...
					BiomeGenBase biomegenbase = TESCrashHandler.getBiomeGenForCoords(world, i1, l);
