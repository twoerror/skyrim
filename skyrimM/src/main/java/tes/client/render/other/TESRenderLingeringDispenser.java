...
public class TESRenderLingeringDispenser implements IBehaviorDispenseItem {
	@Override
	...
	private static class MyBehaviorProjectileDispense extends BehaviorProjectileDispense {
		...
		public IProjectile getProjectileEntity(World world, IPosition pos) {
			return new TESEntityLingeringPotion(world, pos.getX(), pos.getY(), pos.getZ(), stack.copy());
		}
	}
}