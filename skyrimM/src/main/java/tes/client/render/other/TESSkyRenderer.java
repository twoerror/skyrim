...
public class TESSkyRenderer extends IRenderHandler {
	private static final ResourceLocation MOON_TEXTURE = new ResourceLocation("tes:textures/sky/moon.png");
	private static final ResourceLocation SUN_TEXTURE = new ResourceLocation("tes:textures/sky/sun.png");
	private static final ResourceLocation BIG_STAR_TEXTURE = new ResourceLocation("tes:textures/sky/bigstar.png");

	private final TESRandomSkins skyTextures;
	private final int glSkyList;
	private final int glSkyList2;

	private ResourceLocation currentSkyTexture;

	public TESSkyRenderer() {
		int k;
		int j;
		skyTextures = TESRandomSkins.loadSkinsList("tes:textures/sky/night");
	...
	public void render(float partialTicks, WorldClient world, Minecraft mc) {
		world.theProfiler.startSection("tesSky");
		...
		if (biome instanceof TESBiome && renderSkyFeatures) {
		...
		if (renderSkyFeatures) {
			...
			GL11.glBlendFunc(770, 1);
			GL11.glColor4f(1.0f, 1.0f, 1.0f, rainBrightness);
			int phases = TESWorldProvider.MOON_PHASES;
			int moonPhase = TESWorldProvider.getTESMoonPhase();
			boolean lunarEclipse = TESWorldProvider.isLunarEclipse();
			if (lunarEclipse) {
