...
public class TESRenderCrossbowBolt extends Render {
	private static final ResourceLocation BOLT_TEXTURE = new ResourceLocation("tes:textures/model/crossbow_bolt.png");

	@Override
	public void doRender(Entity entity, double d, double d1, double d2, float f, float f1) {
		TESEntityCrossbowBolt bolt = (TESEntityCrossbowBolt) entity;
		...
		int yOffset = 0;
		if (boltItem != null && boltItem.getItem() instanceof TESItemCrossbowBolt && ((TESItemCrossbowBolt) boltItem.getItem()).isPoisoned()) {
			yOffset = 1;
		}
		float f2 = 0.0f;
		float f3 = 0.5f;
