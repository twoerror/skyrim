...
public class TESRenderCrossbow implements IItemRenderer {
	@Override
	...
	public void renderItem(IItemRenderer.ItemRenderType type, ItemStack itemstack, Object... data) {
		...
		boolean loaded = TESItemCrossbow.isLoaded(itemstack);
		boolean using = false;
		if (holder instanceof EntityPlayer) {
			...
			if (using && holder instanceof TESEntityNPC) {
				using = ((TESEntityNPC) holder).isClientCombatStance();
			}
		}
		if (TESRenderBow.isRenderingWeaponRack()) {
