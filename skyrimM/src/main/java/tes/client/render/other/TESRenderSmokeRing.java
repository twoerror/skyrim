...
import tes.client.model.TESModelSmokeShip;
...
public class TESRenderSmokeRing extends Render {
	private static final ModelBase MAGIC_SHIP_MODEL = new TESModelSmokeShip();
	...
	public void doRender(Entity entity, double d, double d1, double d2, float f, float f1) {
		...
		TESEntitySmokeRing smokeRing = (TESEntitySmokeRing) entity;
	...
	public ResourceLocation getEntityTexture(Entity entity) {
		return TESClientProxy.PARTICLES_TEXTURE;
	}
}