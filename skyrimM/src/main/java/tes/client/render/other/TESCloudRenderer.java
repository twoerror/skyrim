...
public class TESCloudRenderer extends IRenderHandler {
	private static final ResourceLocation CLOUD_TEXTURE = new ResourceLocation("tes:textures/sky/clouds.png");
	...
	public void render(float partialTicks, WorldClient world, Minecraft mc) {
		if (world.provider.isSurfaceWorld()) {
			world.theProfiler.startSection("tesClouds");
			int cloudRange = TESConfig.cloudRange;
			GL11.glMatrixMode(5889);
			GL11.glPushMatrix();
			GL11.glLoadIdentity();
			float fov = TESReflectionClient.getFOVModifier(mc.entityRenderer, partialTicks, true);
