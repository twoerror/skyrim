...
import tes.client.model.TESModelDragon;
...
public class TESRenderDragon extends RenderLiving {
	private static final ResourceLocation DISSOLVE = new ResourceLocation("tes:textures/entity/animal/dragon/dissolve.png");
	private static final ResourceLocation EGG_TEXTURE = new ResourceLocation("tes:textures/entity/animal/dragon/egg.obj");
	private static final IModelCustom EGG = AdvancedModelLoader.loadModel(EGG_TEXTURE);

	private TESModelDragon model;

	public TESRenderDragon() {
		super(null, 2);
	}

	@Override
	public void doRender(EntityLiving entity, double x, double y, double z, float yaw, float partialTicks) {
		TESEntityDragon dragon = (TESEntityDragon) entity;
		mainModel = renderPassModel = model = new TESModelDragon();
	...
	private void doRenderEgg(TESEntityDragon dragon, double x, double y, double z, float partialTicks) {
		TESDragonLifeStageHelper lifeStage = dragon.getLifeStageHelper();
