...
import tes.client.model.TESModelManticore;
...
public class TESRenderManticore extends RenderLiving {
	private static final ResourceLocation TEXTURE = new ResourceLocation("tes:textures/entity/animal/manticore.png");

	public TESRenderManticore() {
		super(new TESModelManticore(), 0.5f);
	}
