...
public class TESEntityAngryFX extends EntityFX {
	private final float angryScale;

	public TESEntityAngryFX(World world, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
	...
	public void renderParticle(Tessellator tessellator, float f, float f1, float f2, float f3, float f4, float f5) {
		float modScale = TESFunctions.normalisedCos((particleAge + f) / 12.0f);
