...
public class TESEntityRiverWaterFX extends EntitySpellParticleFX {
	public TESEntityRiverWaterFX(World world, double d, double d1, double d2, double d3, double d4, double d5, int color) {
