...
public class TESEntityLeafFX extends EntityFX {
	private final int[] texIndices;

	public TESEntityLeafFX(World world, double d, double d1, double d2, double d3, double d4, double d5, int[] tex) {
	...
	public TESEntityLeafFX(World world, double d, double d1, double d2, double d3, double d4, double d5, int[] tex, int age) {
