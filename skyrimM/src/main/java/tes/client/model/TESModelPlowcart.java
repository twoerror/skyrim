...
import tes.common.entity.other.inanimate.TESEntityPlowcart;
import net.minecraft.client.model.ModelBase;
import net.minecraft.client.model.ModelRenderer;
import net.minecraft.entity.Entity;

public class TESModelPlowcart extends ModelBase {
	...
	public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float rotationYaw, float rotationPitch, float scale, Entity entity) {
		...
		plowShaftUpper.rotateAngleX = ((TESEntityPlowcart) entity).getPlowing() ? 0.7853982f : 1.2566371f;
