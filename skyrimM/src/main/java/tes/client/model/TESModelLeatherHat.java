...
public class TESModelLeatherHat extends TESModelBiped {
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
		GL11.glPushMatrix();
		int hatColor = TESItemLeatherHat.getHatColor(hatItem);
		...
		if (TESItemLeatherHat.hasFeather(hatItem)) {
			...
			int featherColor = TESItemLeatherHat.getFeatherColor(hatItem);
