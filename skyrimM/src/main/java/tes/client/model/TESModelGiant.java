...
public class TESModelGiant extends ModelBase {
	...
	public TESModelGiant() {
		this(0.0f);
	}

	public TESModelGiant(float f, int i) {
		this(f);
		isOutiftModel = true;
		switch (i) {
			case 0:
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
		...
		boolean isHurt = entity instanceof TESEntityGiantBase && !isOutiftModel;
		if (isHurt) {
			headHurt.render(f5);
		} else {
			head.render(f5);
	...
	public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity entity) {
		...
		if (entity instanceof TESEntityGiantBase) {
		...
		boolean throwing = entity instanceof TESEntityGiantBase && ((TESEntityGiantBase) entity).isThrowingRocks();
		if (throwing) {
