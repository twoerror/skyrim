...
import tes.client.render.other.TESGlowingEyes;
import tes.common.entity.other.TESEntityNPC;
import net.minecraft.client.model.ModelRenderer;
import net.minecraft.entity.Entity;
import org.lwjgl.opengl.GL11;

public class TESModelHuman extends TESModelBiped implements TESGlowingEyes.Model {
	protected final ModelRenderer bipedChest = new ModelRenderer(this, 24, 0);

	public TESModelHuman() {
		this(0.0f, false);
	}

	public TESModelHuman(float f, boolean armor) {
