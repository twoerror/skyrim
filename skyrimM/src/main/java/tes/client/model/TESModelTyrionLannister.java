...
public class TESModelTyrionLannister extends TESModelBiped {
	private final ModelRenderer bipedChest;

	public TESModelTyrionLannister() {
		this(0.0f);
	}

	public TESModelTyrionLannister(float f) {
		this(f, f == 0.0f ? 64 : 32);
	}

	private TESModelTyrionLannister(float f, int height) {
