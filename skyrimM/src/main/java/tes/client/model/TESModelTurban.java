...
public class TESModelTurban extends TESModelRobes {
	private final ModelRenderer ornament;

	public TESModelTurban(float f) {
		super(f);
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
		...
		TESArmorModels.copyBoxRotations(ornament, bipedHead);
		ornament.showModel = bipedHead.showModel && TESItemTurban.hasOrnament(robeItem);
		ornament.render(f5);
	}
}