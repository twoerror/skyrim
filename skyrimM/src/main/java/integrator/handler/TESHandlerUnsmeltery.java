...
import tes.client.gui.TESGuiUnsmeltery;
...
public class TESHandlerUnsmeltery extends FurnaceRecipeHandler {
	private static final TESTileEntityUnsmeltery INSTANCE = new TESTileEntityUnsmeltery();

	@Override
	public Class<? extends GuiContainer> getGuiClass() {
		return TESGuiUnsmeltery.class;
	}

	@Override
	public String getGuiTexture() {
		return "tes:textures/gui/unsmelter.png";
	}
	...
	public void loadCraftingRecipes(ItemStack result) {
		...
		for (Item item : (Iterable<Item>) items) {
			...
			ItemStack unsmeltingResult = TESTileEntityUnsmeltery.getEquipmentMaterial(stack);
	...
	public TemplateRecipeHandler newInstance() {
		return new TESHandlerUnsmeltery();
	}
