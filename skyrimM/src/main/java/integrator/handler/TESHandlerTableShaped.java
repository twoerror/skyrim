...
public class TESHandlerTableShaped extends ShapedRecipeHandler {
	private final List<IRecipe> recipeList;
	private final Class<? extends GuiContainer> guiClass;
	private final String recipeName;

	public TESHandlerTableShaped(List<IRecipe> recipes, Class<? extends GuiContainer> gui, String name) {
		recipeList = recipes;
		guiClass = gui;
		recipeName = name;
	}
	...
	public TemplateRecipeHandler newInstance() {
		return new TESHandlerTableShaped(recipeList, guiClass, recipeName);
	}
