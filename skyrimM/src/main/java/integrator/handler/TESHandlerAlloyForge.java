...
import tes.client.gui.TESGuiAlloyForge;
...
public class TESHandlerAlloyForge extends TemplateRecipeHandler {
	private static final TESTileEntityAlloyForge INSTANCE = new TESTileEntityAlloyForge();
	...
	private List<CachedForgeRecipe> getAlloySmeltingRecipes(ItemStack result) {
		...
		for (TESTileEntityAlloyForge.CraftingSnapshot craftingSnapshot : TESTileEntityAlloyForge.CRAFTING_SNAPSHOTS) {
	...
	public Class<? extends GuiContainer> getGuiClass() {
		return TESGuiAlloyForge.class;
	}

	@Override
	public String getGuiTexture() {
		return "tes:textures/gui/forge.png";
	}
	...
	private void handlerCRStack(Item forgeItem, ItemStack result) {
		...
		if (NEIServerUtils.areStacksSameType(TESTileEntityAlloyForge.getSmeltingResult(stack), result)) {
	...
	public void loadUsageRecipes(ItemStack ingredient) {
		ItemStack tmp = TESTileEntityAlloyForge.getSmeltingResult(ingredient);
		if (tmp != null) {
