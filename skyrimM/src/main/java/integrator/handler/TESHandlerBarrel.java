...
import tes.client.gui.TESGuiBarrel;
...
public class TESHandlerBarrel extends ShapelessRecipeHandler {
	private final Collection<CachedBarrelRecipe> barrelRecipes = new ArrayList<>();
	private final Random rand = new Random();

	public TESHandlerBarrel() {
		for (ShapelessOreRecipe rec : TESRecipeBrewing.RECIPES) {
	...
	public String getRecipeName() {
		return StatCollector.translateToLocal("tes.container.barrel");
	}
